...
public class ComponenteActivosBackBean extends BaseBackBean implements Serializable {
	...
	private static final long serialVersionUID = 1L;
	 ...
	 private CaracteristicasHardware componenteDisponibleSeleccionado;
	...
	public void cargarListaComponentesDisponibles(){
	...
	public void asociarComponente(){
		 try {
			 ComponentesActivos oComponenteActivo = new ComponentesActivos();
			 if(componenteDisponibleSeleccionado==null) {
				 throw new BusinessException("SELECCIONE UN COMPONENTE DE LA LISTA DE COMPONENTES DISPONIBLES.");
			 }else{
				 oComponenteActivo.setActivoId(equipoSeleccionado.getId());
				 oComponenteActivo.setComponenteId(componenteDisponibleSeleccionado.getId());
	...
	public void cargarDatosComponentesEquipo(){
		this.cargarListaComponentesDisponibles();
	...
	public CaracteristicasHardware getComponenteDisponibleSeleccionado() {
		return componenteDisponibleSeleccionado;
	}

	public void setComponenteDisponibleSeleccionado(CaracteristicasHardware componenteDisponibleSeleccionado) {
		this.componenteDisponibleSeleccionado = componenteDisponibleSeleccionado;
	}
